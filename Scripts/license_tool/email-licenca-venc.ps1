...
$EmailSubject = "Licenca Vencida - SETOR FINANCEIRO." 
$EmailBody = "<Body>
Prezados colaboradores da empresa <B> $empresa_nome</B>, informamos que o sistema Mercadologic teve seu servico REMOVIDO por falta de renovacao de licenca.
<p>
<B>FAVOR ENTRAR EM CONTATO COM O SETOR FINANCEIRO PARA VALIDACAO:</B>
<p>
